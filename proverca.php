...
if (empty($login) or empty($password)) //если пользователь не ввел логин или пароль, то выдаем ошибку и останавливаем скрипт
 ...
 //    $myrow = mysql_fetch_array($result);
    ...
    if($login=="ivanov@smt.com")
    {
        if($password=="hackaton")
        {
            $_SESSION['login']=$myrow["login"]; 
            $_SESSION['id']=$myrow["id"];//эти данные очень часто используются, вот их и будет "носить с собой" вошедший пользователь
            $_SESSION['password']=$password; //не делать так
        ...
        else
        {
            ...
            <h3>Пароль неверный." . " <a href='index.php'><b>Назад</b></a></h3></div></body>");
        }
    }
    else
    {
        exit ("<body><div align='center'>
       <h3>Логин неверный." . " <a href='index.php'><b>Назад</b></a></h3></div></body>");
    }
